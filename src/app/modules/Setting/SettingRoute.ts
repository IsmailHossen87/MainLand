...
router.delete("/delete-contact/:id", auth(USER_ROLES.ADMIN), SettingController.deleteContact);
...
router.patch("/faq/:id", auth(USER_ROLES.ADMIN, USER_ROLES.ORGANIZER, USER_ROLES.USER), SettingController.faqUpdate);
