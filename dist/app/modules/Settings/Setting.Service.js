...
const getSpecificSetting = (key) => __awaiter(void 0, void 0, void 0, function* () {
    if (key === 'terms_and_conditions') {
        const termsAndConditions = yield Setting_model_1.Settings.findOne({ type: Setting_model_1.SettingType.TermsAndConditions });
        const privacyPolicy = yield Setting_model_1.Settings.findOne({ type: Setting_model_1.SettingType.PrivacyPolicy });
        const data = {
            termsAdnCondition: (termsAndConditions === null || termsAndConditions === void 0 ? void 0 : termsAndConditions.content) || "",
            privacyPolicy: (privacyPolicy === null || privacyPolicy === void 0 ? void 0 : privacyPolicy.content) || ""
        };
        return data;
    }
...
const getTermsAndCondition = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Setting_model_1.Settings.findOne({ type: 'terms_and_conditions' });
    return result;
});
...
const createTerms = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { type, title, content } = data;
    const result = yield Setting_model_1.Settings.findOneAndUpdate({ type }, { title, content }, { upsert: true, new: true });
    return result;
});
