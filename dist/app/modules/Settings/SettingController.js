...
const createTerms = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield Setting_Service_1.SettingService.createTerms({ type, title, content });
        res.status(http_status_codes_1.StatusCodes.OK).json({
            success: true,
            message: `${type} updated successfully`,
            data: result,
...
const getTermsAndCondition = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
